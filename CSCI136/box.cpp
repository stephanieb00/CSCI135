...
Assignment:Task C. Add a white box.,Lab8C

This program will read a PGM image from the file "inImage.pgm", and outputs a modified image to "outImage.pgm". It will draw a white box exactly in the middle of the picture. The dimensions of the box should be 50% by 50% of the original picture’s width and height.
*/
